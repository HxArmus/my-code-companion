...
## Overview  
**CodeCompanion** is an intelligent code analysis platform that provides AI-powered code reviews, explanations, error analysis, and tech article recommendations. The project consists of both frontend and backend components, working together to deliver a seamless experience for developers.  
